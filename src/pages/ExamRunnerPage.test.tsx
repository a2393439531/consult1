...
vi.mock('../data/manifest', () => ({
  ...
  loadChapter: vi.fn().mockResolvedValue({ id: '1', number: 1, title: '第一章', questions: [{ id: 'case-1', title: '测试题', chapter_id: '1', topics: [], question_type: '案例题', difficulty: '中', background: '背景', subquestions: [{ id: 'q1', prompt: '问题', answer: { reference: '答案', analysis: '', scoring_points: [], pitfalls: [] } }], sources: [{ source_id: 's', file_name: '模考.pdf', pages: [1] }], exam_ids: [], needs_review: false, review_notes: [] }] })
}))
